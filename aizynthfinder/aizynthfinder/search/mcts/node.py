...
class MctsNode:
    ...
    def __init__(
        ...
        self._yield_scorer = config.yield_scorer
        self.yield_score_parameter = config.yield_score_parameter
        self.tree = owner
    ...
    def expand(self) -> None:
        ...
        if self._yield_scorer:
            (
                self._children_actions,
                self._children_priors,
            ) = self._yield_scorer.score_single_step_with_yield(self._children_actions,
                self._children_priors, self.yield_score_parameter)
